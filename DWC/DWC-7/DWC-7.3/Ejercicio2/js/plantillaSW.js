import * as script from "./ejercicio2.js";
...
function mostrarInformacionPersonaje(posicionArray, datosPersonajes) {
...
function mostrarPersonajesPelicula(personajes, datosPersonajes) {
  let body = document.getElementById("body");
...
function mostrarInformacionPelicula(pelicula) {
  ...
  script.enviarPeticionPersonajes(pelicula.characters);
}
